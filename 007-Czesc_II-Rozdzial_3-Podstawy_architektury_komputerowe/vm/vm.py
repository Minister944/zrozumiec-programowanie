...
from dev_con import VMDeviceConsole
from dev_timer import VMDeviceTimer
from instr import VM_OPCODES
...
class VMInstance(object):
    ...
    def run_single_step(self):
        ...
        Debug.debug_colored(handler.__name__, self.r, argument_bytes)
